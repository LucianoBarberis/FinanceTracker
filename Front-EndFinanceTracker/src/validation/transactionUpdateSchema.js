...
export const transactionUpdateSchema = (categories) => { 
    return z.object({
        id: z.any().optional(),
        ...
        const selectedCategory = categories?.find(d => d.id === data.categoryId)
        if (!selectedCategory) return true
        return selectedCategory.type === data.type
    }, {
        message: "La categoría no coincide con el tipo de transacción.",
        path: ["categoryId"]
    })
};